                ...
                try:
                    ...
                    for event in pygame.event.get():
                        ...
                        if event.type == pygame.MOUSEBUTTONDOWN:
                            ...
                            # Check if the mouse click is within the bounds of the mute icon
                            if mute_icon_x <= mouse_x <= mute_icon_x + 50 and mute_icon_y <= mouse_y <= mute_icon_y + 50:
                                if pygame.mixer.music.get_busy():  # Check if music is currently playing
                                    pygame.mixer.music.pause()  # Pause the music
                                    mute_icon = load_and_scale_image('mute.png', 50, 50)  # Update mute icon
                                else:
                                    pygame.mixer.music.unpause()  # Unpause the music if it's paused
                                    mute_icon = load_and_scale_image('sound.png', 50, 50)  # Update sound icon
                    ...
                    clock.tick(fps)
                            ...
                            # Ensure mute_icon is defined before accessing it
                            if 'mute_icon' in globals() and pygame.mixer.music.get_busy():
                                pygame.mixer.music.pause()
                                mute_icon = load_and_scale_image('mute.png', 50, 50)  
                            else:
                                mute_icon = load_and_scale_image('sound.png', 50, 50)
